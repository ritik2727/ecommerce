...
function Chat() {
  ...
  const steps = [
    ...
    },
    {
      id: "9",
      message:
        "You will receive call from our customer care, shortly.Or you can email us at reactjsdeveloper45@gmail.com",
      trigger: "6",
    },
    {
      id: "11",
  ...
  return (
    <div>
      <ThemeProvider theme={theme}>
        <ChatBot headerTitle="Jarvis Assistant" floating="true" steps={steps} />
      </ThemeProvider>
    </div>
  );
}
