...
import { Divider, Grid, makeStyles, Typography,useMediaQuery,useTheme,Button, Hidden } from '@material-ui/core';
   ...
   if (dataOrder.length === 0)
      ...
      <div style={{alignItems:'center'}}>
         ...
         >
            ...
            <Grid 
               item 
               style={{marginTop:matchesMD?'2em':'inherit'}}
            >
               <img 
          ...
          <Grid container direction='column' className={classes.rowContainer} >
              <Grid item>
                <Typography variant={matchesXS?'h5':'h3'} 
                  style={{paddingLeft:matchesXS?0:matchesSM?'5em':'8em',fontWeight:'bold',fontSize:'2rem'}}
               >
                    My Orders
            ...
            <Grid item >
                {/* first Item */}
                {dataOrder && dataOrder.map(doc=>
            <div>
               <Hidden smUp>
                  <Typography  variant={matchesXS?'body2':'h6'} style={{color:'black',marginTop:'0.5em'}}>
                     #Order ID:{doc.key}
                  </Typography>
               </Hidden>
            <Card 
                ...
                style={{
                        marginBottom:'2em',
                        width:matchesXS?'18em':matchesSM ? '35em':matchesMD?'40em':'50em',
            ...
            >
                ...
                <div className={classes.details}>
                    ...
                    <Typography variant={matchesXS?'body2':'h6'} style={{marginTop:'1em'}}>
